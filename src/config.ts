...
const SITE_TITLE = "方鹿的瞎玩日志∠( ᐛ 」∠)";
const SITE_SUBTITLE = "Code and learn for fun!";
export const siteConfig: SiteConfig = {
	title: SITE_TITLE,
	subtitle: SITE_SUBTITLE,
	siteURL: "https://blockydeer.me/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2024-02-03", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	banner: {
		...
		src: {
			desktop: ["/assets/desktop-banner/83355125_p0.webp"], // 桌面横幅图片
			mobile: ["/assets/mobile-banner/134520119_p0.webp"], // 移动横幅图片
		}, // 使用本地横幅图片
		...
		homeText: {
			...
			typewriter: {
				...
				speed: 100, // 打字速度（毫秒）
				deleteSpeed: 0, // 删除速度（毫秒）
				pauseTime: Infinity, // 完全显示后的暂停时间（毫秒）
			},
		},

		credit: {
			enable: true, // 显示横幅图片来源文本
			text: "Art by takepon", // 要显示的来源文本
			url: "https://www.pixiv.net/users/25652054", // （可选）原始艺术品或艺术家页面的 URL 链接
		},
	...
	favicon: [
		// 留空以使用默认 favicon
		{
			src: "assets/favicon/favicon.png", // 图标文件路径
...
export const announcementConfig: AnnouncementConfig = {
	title: "公告", // 公告标题
	content: "网站已转为使用 Mizuki 模板！", // 公告内容
